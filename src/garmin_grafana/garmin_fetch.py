                        ...
                        if parsed_record.get('timestamp'):
                            point = {
                                ...
                                "fields": {
                                    ...
                                    "GradeAdjustedSpeed": (parsed_record["unknown_140"]) / 1000.0 if parsed_record.get("unknown_140") else None,
                                    "RunningEfficiency":((parsed_record["unknown_140"]) / 1000.0)/parsed_record.get('heart_rate') if parsed_record.get("unknown_140") and parsed_record.get('heart_rate') else None,
